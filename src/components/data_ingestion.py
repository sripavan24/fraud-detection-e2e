...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        logging.info("Entered the ingestion method or componts")
        try:
            df=pd.read_csv("notebook\data\creditcard.csv")
            logging.info("read dataset as datafram")
            ...
            logging.info("inmgestion of the is complet")
            
            return (self.ingestion_congif.train_data_path,
